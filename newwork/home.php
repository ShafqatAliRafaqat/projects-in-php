...
<div class="row">
<div class="col-sm-offset-4 col-sm-4" id="myfirstchart" style="height: 250px;">
<script>
...
<div class="col-sm-6" id="pform">

<div class="panel panel-success">
<div class="panel-heading">Add Prodcut</div>
<div class="panel-body">

<form action="javascript:insertdata();" method="post">
<?php
$query_max=mysqli_query($database,"SELECT MAX(PRODUCtCODE) AS ID FROM products");
...
<input type="text" class="form-control" Required   onchange="checkpcode();" value="<?php echo $id ?>" id="pcode" placeholder="Enter Product Code">
</div>

<div class="form-group">
<label class="control-label"> Product Name:</label>
<input type="text" class="form-control" Required   id="punit" placeholder="Enter Product Name">
</div>

<div class="form-group">
<label class="control-label"> Product Unit:</label>
<input type="text" class="form-control" Required id="psale" placeholder="Enter Product Unit">
</div>

<div class="form-group">
<label class="control-label"> Product Type:</label>
<input type="text" class="form-control" Required id="ppurchase" placeholder="Enter Product Type">
</div>


<div class="form-group">
<div class="col-sm-offset-4 col-sm-4">
<input type="submit" value="Add Product" class="btn btn-success btn-md" />
</div>
</div>
...
$runquery=mysqli_query($database,"SELECT * FROM products ORDER  BY PRODUCTCODE ASC");
while ($result=mysqli_fetch_array($runquery,MYSQLI_BOTH))
{
?>      
...
<td><?php echo $result['PRODUCTUNIT']?></td>
<td><?php echo $result['PRODUCTSALE']?></td>
<td><?php echo $result['PRODUCTPURCHASE']?></td>
<td>
<div class="dropdown">
<button class="btn btn-danger dropdown-toggle" type="button" data-toggle="dropdown">Action
<span class="caret"></span></button>
<ul class="dropdown-menu">
<li><a href="#" onclick="editdata(<?php echo $result['PRODUCTCODE']?>);" >Edit</a></li>
<li class="divider"></li>
<li><a href="#" onclick="deletedata(<?php echo $result['PRODUCTCODE'] ?>);" >Delete</a></li>
<li class="divider"></li>
<li><a href="#" onclick="detaildata(<?php echo $result['PRODUCTCODE']?>);" >Details</a></li>
</ul>
</div>
...
//Waves.attach('.waves-button', ['waves-button', 'waves-float', 'waves-light']);
